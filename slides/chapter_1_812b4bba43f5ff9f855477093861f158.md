...
Histogram-based. The histogram is a graphical representation of the frequency distribution table of the image and its density. It acts based on the properties of this histogram. Good with uniform backgrounds.
...
`@script`
Previously, we manually set the thresh value, but a better way to know what thresh could work better on an image is to calculate it using a bimodal histogram method. In this case we are trying the minimum algorithm. 
...
We can see how the minimum is spotted by a red line.
