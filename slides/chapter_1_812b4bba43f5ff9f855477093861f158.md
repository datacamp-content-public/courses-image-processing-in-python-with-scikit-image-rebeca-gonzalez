...
`@script`
We can calculate a possible optimal threshold with the function threshold_otsu, this is a clustering-based method that does this by maximizing the variance between two classes of pixels, which are separated by the threshold.
