...
`@part1`
- Histogram is a graphical representation of the tonal distribution.
...
`@script`
Remember that histogram is a graphical representation of tonal distribution in an image. 
